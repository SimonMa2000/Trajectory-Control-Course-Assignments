...
% 
% Result: The result of the test (if use heuristic guess No.3) shows that the 
% pendulum swings two times before reaching its destination.

% The following line is used in Linux version Matlab 
